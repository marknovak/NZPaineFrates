%latex.default(xtable(summary(regPredPrey)), file = "../tables/Paine-PredPreySize.tex",     rowlabel = "", label = "tab:Size", first.hline.double = FALSE,     caption = "Summary table for the regression of predator size \n  on prey size.",     digits = 3, where = "!htbp")%
\begin{table}[!htbp]
