%latex.default(xtable(summary(regPredPreyYearInt)), file = "../tables/Paine-PredPreySizeYearInt.tex",     rowlabel = "", label = "tab:SizeYint", first.hline.double = FALSE,     caption = "Summary table for the regression of predator size on prey size,\n  time period (\\emph{Year}), and their interaction.",     digits = 3, where = "!htbp")%
\begin{table}[!htbp]
